...
string CityName[] = {"WareHouse", "Hyderabad", "Warangal", "Nizamabad", "Nalgonda", "Khammam", "Karimnagar", "Suryapet", "Siddipet", "Adilabad", "Mahabubnagar"};

string Suryapet[]={"Suryapet", "Kodad", "Huzurnagar", "Neredcherla", "Thirumalagiri", "Thungathurthy"};

string Hyderabad[]={"Hyderabad", "LB Nagar" ,"Jubilee Hills", "Gachibowli", "Punjagutta", "Malakpet"};

string Warangal[]={"Warangal", "Laxmipur", "Garden Town", "Khanapur", "Nallabelly", "Sangem"};

string Nizamabad[]={"Nizamabad", "Armur", "Ghanpur", "Kamareddy", "Yellareddy", "Soanpet"};

int graph[V][V]={   {0, 4, 0, 0, 0, 0, 0, 0, 0, 0, 3},   //Warehouse
					{4, 0, 0, 0, 0, 0, 0, 6, 0, 0, 2},	 //Hyderabad
					{0, 0, 0, 0, 9, 4, 0, 0, 0, 0, 11},	 //Warangal
					{0, 0, 0, 0, 1, 0, 0, 0, 16, 5, 0},	 //Nizamabad
					{0, 0, 9, 1, 0, 8, 13, 0, 10, 6, 0}, //Nalgonda	
					{0, 0, 4, 0, 8, 0, 0, 3, 17, 0, 7},	 //Khammam
					{0, 0, 0, 0, 13, 0, 0, 0, 0, 0, 7},	 //Karimnagar
					{0, 6, 0, 0, 0, 3, 0, 0, 5, 0, 0},	 //Suryapet
					{0, 0, 0, 16, 10, 17, 0, 5, 0, 0, 0},//Siddipet
					{0, 0, 0, 5, 6, 0, 0, 0, 0, 0, 0},	 //Adilabad
					{3, 2, 11, 0, 0, 7, 7, 0, 0, 0, 0}  };//Mahabubnagar
					
//----------------------Suryapet--------------------------------				
int SurGraph[V1][V1]={ 	{ 0, 4, 4, 0, 0, 0 },
						{ 4, 0, 2, 0, 0, 0 },   //Kodad
						{ 4, 2, 0, 3, 2, 4 },	//Huzurnagar
						{ 0, 0, 3, 0, 0, 3 },	//Neredcherla
						{ 0, 0, 2, 0, 0, 3 },	//Thirumalagiri
						{ 0, 0, 4, 3, 3, 0 } };	//Thungathurthy
						
//---------------------Hyderabad------------------------------------
int HydGraph[V1][V1]={ 	{ 0, 4, 0, 2, 0, 0 },
						{ 4, 0, 3, 1, 0, 6 },	//LB Nagar
						{ 0, 3, 0, 4, 0, 7 },	//Jubilee Hills
						{ 2, 1, 4, 0, 9, 0 },	//Gachibowli
						{ 0, 0, 0, 9, 0, 5 },	//Punjagutta
						{ 0, 6, 7, 0, 5, 0 } };	//Malakpet

//-----------------------Warangal---------------------------------------
int WarGraph[V1][V1]={ 	{ 0, 9, 15, 6, 0, 0 },
						{ 9, 0, 7, 0, 0, 8 },  // Laxmipur
						{ 15, 7, 0, 8, 9, 5 }, // Polaram
						{ 6, 0, 8, 0, 11, 0 }, // Khanapur
						{ 0, 0, 9, 11, 0, 0 }, // Nallabelly
						{ 0, 8, 5, 0, 0, 0 } };	//Sangem

//----------------------Nizamabad----------------------------------------
int NizGraph[V1][V1]={ 	{ 0, 6, 3, 0, 0, 1 },
						{ 6, 0, 0, 2, 0, 5 },	//Armur
						{ 3, 0, 0, 0, 3, 5 },	//Ghanpur
						{ 0, 2, 0, 0, 6, 4 },	//Kamareddy
						{ 0, 0, 3, 6, 0, 6 },	//Yellareddy
						{ 1, 5, 5, 4, 6, 0 } };	//Soanpet
...
int Atd(){
	int opt;
	cout << "\nThe delivery is available for following Areas in Suryapet: " << endl;
    ...
    cout<<"\n |     2    |    Huzurnagar            |"<<endl;
    cout<<"\n |     3    |    Neredcherla       |"<<endl;
	cout<<"\n |     4    |    Thirumalagiri   |"<<endl;
    cout<<"\n |     5    |    Thungathurthy   |"<<endl;
    cout<<"---------------------------------\n"<<endl;
...
int Lhr(){
	int opt;
	cout << "\nThe delivery is available for following Areas in Warangal: " << endl;
...
int Kar(){
	int opt;
	cout << "\nThe delivery is available for following Areas in Nizamabad: " << endl;
...
int FurthurArea(int option){
	...
	switch(option){
			...
			case 1: 
			{
				...
				opt=isb();
				addressF=Hyderabad[opt];
			}
			break;
			
			case 2:
			{
				prims(WarGraph,distanceP);
				opt=Lhr();
				addressF=Warangal[opt];
			}
			break;
			
			case 3:
			{
				prims(NizGraph,distanceP);
				opt=Kar();
				addressF=Nizamabad[opt];
			}
			break;
			
			case 7:
			{
				prims(SurGraph,distanceP);
				opt=Atd();
				addressF=Suryapet[opt];
			}
			break;
		}
...
int main()
{
	shop =new Shop;
	shop->name="WareHouse";
	shop->address="Eternal Palace, Green Hills Colony, Hyderabad";
	...
	do
    {
        ...
        cout<<"\n---------------------------------------------------------------------";
        cout<<"\n |    1     | 		  Sony Bravia XR-75X90L               |       45500     |"<<endl;
        cout<<"\n |    2     | 		  Samsung UA50DUE70BKLXL		  |       175000    |"<<endl;
        cout<<"\n |    3     |            	TCL 75C755           |       289000    |"<<endl;
        cout<<"\n |    4     |              LG 32LQ643BPTA               |       155700    |"<<endl;
        cout<<"\n |    5     |          OnePlus 65 Q2 Pro        |       75000     |"<<endl;
        cout<<"\n |    6     |            LG 43UR7500PSC           |       210000    |"<<endl;
        cout<<"\n |    7     |            Xiaomi L50M8-5XIN             |       199999    |"<<endl;
        cout<<"\n |    8     |             Blaupunkt 55QD7020              |       100000    |"<<endl;
        cout<<"\n |    9     |          Panasonic TH-43MS660DX        |       45000     |"<<endl;
        cout<<"\n |    10    |           Redmi L43R8-FVIN         |       500000    |";
        cout<<"\n---------------------------------------------------------------------"<<endl;
		}
		break ;	
